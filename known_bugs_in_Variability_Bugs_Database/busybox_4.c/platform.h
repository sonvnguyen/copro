...
#if (defined __digital__ && defined __unix__) || defined __APPLE__ || defined __FreeBSD__ || defined __OpenBSD__ || defined __NetBSD__
# undef HAVE_CLEARENV
...
#if defined __GLIBC__ || defined __UCLIBC__ || defined __dietlibc__ || defined _NEWLIB_VERSION
# include <features.h>
#endif
 ...
 */
#if ENABLE_NOMMU || (defined __UCLIBC__ && __UCLIBC_MAJOR__ >= 0 && __UCLIBC_MINOR__ >= 9 && __UCLIBC_SUBLEVEL__ > 28 && !defined __ARCH_USE_MMU__)
# define BB_MMU 0
